...
index 06ed5a441fbeed55ec1169281aa9f4934b5a85ed..589a6d3582c2c771d670aa85c106e6581739c2bc 100644
--- a/app.py
+++ b/app.py
@@ -1,629 +1,707 @@
...
+    """ดึง API key จาก Streamlit secrets แบบปลอดภัย"""
+    key = st.secrets.get("IMGBB_API_KEY", "") if hasattr(st, "secrets") else ""
+    if not key:
+        st.error("🚨 ไม่พบ IMGBB_API_KEY ใน secrets กรุณาตั้งค่าก่อนใช้งาน")
+        return None
+    return key
+
+
