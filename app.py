...
# ------------------------------------------
# 📚 หน้า 2: คลังนิยาย (Single Page Edit & 6 Columns)
# ------------------------------------------
elif menu == "📚 คลังนิยาย":
    # 📌 โหมดแก้ไขแบบเต็มจอ
    ...
    # 📌 โหมดแกลลอรี่ (Gallery View 6 Columns)
    else:
